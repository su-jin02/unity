...
public class HYS_dice1 : MonoBehaviour
{
    Vector3 V0, V1, V2, V3;
    Vector3[] newVertices;
    int[] newTriangles;
    ...
    void Start()
    {
        ...
        UV0 = new Vector2(0.5f, 0.333f); //uv좌표 정해주기, 0과 1은 범위를 나타냄 uv값 조정해 원하는 부분만 보이도록 할 수 있음
        UV1 = new Vector2(0.5f, 0.666f); //자세한 내용은 week14수업자료에 설명 참고
